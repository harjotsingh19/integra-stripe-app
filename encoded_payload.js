...
// Function to generate a random emailId ID
...
const integraPublicKeyId = crypto.randomBytes(16).toString('hex'); // Random public key ID

// Create first payload


// Generate dynamic data for the second payload
// const emailId = generateRandomEmail();
